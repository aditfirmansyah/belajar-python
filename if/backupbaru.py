...
if (anak_lk == 0 and anak_pr == 0):
    ...
    print(f"Tampil Siham Masalah Anak Perempuan: {asalmasalah_anaklk}")
    print("=" * 20)
    if (suami == "y"):
        ambil_asalmasalah = asalmasalah_suami
    else:
        ambil_asalmasalah = asalmasalah_istri
    totalasalmasalah = ambil_asalmasalah + asalmasalah_ayah + asalmasalah_ibu + asalmasalah_anakpr + asalmasalah_anaklk
    sisa = asalmasalah - totalasalmasalah
    ...
    if (suami == "y"):
        ...
        ambil_asalmasalah = asalmasalah_istri
    totalasalmasalah = ambil_asalmasalah + asalmasalah_ayah + asalmasalah_ibu + asalmasalah_anaklk
    sisa = asalmasalah - totalasalmasalah
    jumlahasalmasalah = sisa + totalasalmasalah
else:
    # mengambil nilai asal masalah suami/istri
