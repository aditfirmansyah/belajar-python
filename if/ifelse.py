...
if (anak_lk == 0 and anak_pr == 0):
    ...
    if (suami == "y"):
        ...
        ambil_asalmasalah = asalmasalah_istri
    totalasalmasalah = ambil_asalmasalah + asalmasalah_ayah + asalmasalah_ibu + asalmasalah_anakpr + asalmasalah_anaklk + asalmasalah_nenek
    sisa = asalmasalah - totalasalmasalah
    jumlahasalmasalah = sisa + totalasalmasalah
elif(anak_lk > 0 and anak_lk == 0):
    print(f"Tampil Siham Masalah Anak Laki-Laki: {asalmasalah_anakpr}")
    print("=" * 20)
    if (suami == "y"):
        ambil_asalmasalah = asalmasalah_suami
    else:
        ambil_asalmasalah = asalmasalah_istri
    totalasalmasalah = ambil_asalmasalah + asalmasalah_ayah + asalmasalah_ibu + asalmasalah_anaklk + asalmasalah_nenek + asalmasalah_kakek
    sisa = asalmasalah - totalasalmasalah
    jumlahasalmasalah = sisa + totalasalmasalah
else:
    # mengambil nilai asal masalah suami/istri
...
if (jumlahasalmasalah == asalmasalah):
    ...
    if (asalmasalah_ayah == 0):
        ...
        if (bagianayah == "sisa" and bagiansisa == ""):
            finalbagianayah = suku_bagian * asalmasalah_ayah
            sisa_harta = harta - ambil_bagian_harta - \
                finalbagianibu - finalbagiananakpr - finalbagianayah - finalbagiannenek
            # suku_bagian = sisa_harta / asalmasalah_sisa
            print("=" * 25)
    ...
    if (asalmasalah_kakek == 0):
        ...
        if (bagiankakek == "sisa" and bagiansisakakek == ""):
            finalbagiankakek = suku_bagian * asalmasalah_kakek
            sisa_harta = harta - ambil_bagian_harta - \
                finalbagianibu - finalbagiananakpr - finalbagiankakek - finalbagiannenek
            # suku_bagian = sisa_harta / asalmasalah_sisa
            print("=" * 25)
            print("Masuk kondisi sisa ayah asal masalah sisa ", asalmasalah_sisa)
            print("Masuk kondisi sisa ayah suku bagian ", suku_bagian)
    ...
    if (anak_pr > 1):
        ...
        if(ayah == "0" and ibu == "0"):
            if(kakek == "y" and nenek > 0):
                sisa_harta = harta - ambil_bagian_harta - finalbagiankakek - finalbagiannenek
                suku_bagian_sisa = sisa_harta / asalmasalah_anakpr
                finalbagiananakpr = suku_bagian_sisa * asalmasalah_anakpr 
