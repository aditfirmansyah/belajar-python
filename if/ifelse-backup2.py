...
if (suami == "y"):
    if (cucu_lk > 0 or cucu_pr > 0):
        asalmasalah_suami = (asalmasalah / 4) * 1
        print(f"Tampil Siham Masalah Suami : {int(asalmasalah_suami)}")
    elif (anak_lk > 0 or anak_pr > 0):
        asalmasalah_suami = (asalmasalah / 4) * 1
        print(f"Tampil Siham Masalah Suami : {int(asalmasalah_suami)}")
    elif (cucu_pr == 0 and anak_pr == 0 and anak_lk == 0 and anak_pr == 0):
        asalmasalah_suami = (asalmasalah / 2) * 1
        print(f"Tampil Siham Masalah Suami : {int(asalmasalah_suami)}")
else:
    asalmasalah_suami = 0
# asal masalah istri
if (istri > 0):
    if (cucu_lk > 0 or cucu_pr > 0):
        asalmasalah_istri = (asalmasalah / 8) * 1
        print(f"Tampil Siham Masalah Istri : {int(asalmasalah_istri)}")
    elif (anak_lk > 0 or anak_pr > 0):
        asalmasalah_istri = (asalmasalah / 8) * 1
        print(f"Tampil Siham Masalah Istri : {int(asalmasalah_istri)}")
    elif (cucu_pr == 0 and anak_pr == 0 and anak_lk == 0 and anak_pr == 0):
        asalmasalah_istri = (asalmasalah / 4) * 1
        print(f"Tampil Siham Masalah Istri : {int(asalmasalah_istri)}")
else:
    asalmasalah_istri = 0
...
if (ibu == "y"):
    if (bagiansisaibu == "*sisa"):
        ...
        asalmasalah_ibu = (asalmasalah / 6) * 1
        print(f"Tampil Siham Masalah Ibu : {int(asalmasalah_ibu)}")
else:
    asalmasalah_ibu = 0
...
if (ayah == "y"):
    if (bagianayah == "sisa"):
        ...
        asalmasalah_ayah = (asalmasalah / 6) * 1
        print(f"Tampil Siham Masalah Ayah : {int(asalmasalah_ayah)}")
else:
    asalmasalah_ayah = 0
...
if (anak_lk == 0 and anak_pr == 0):
    ...
    if (anak_pr > 1 and anak_lk == 0):
        if (ayah == "0" and kakek == 0 and cucu_pr == 0 and cucu_lk == 0):
            asalmasalah_anakpr = (6 / 3) * 2
        else:
            asalmasalah_anakpr = (asalmasalah / 3) * 2
        print(
            f"Tampil Siham Masalah Anak Perempuan : {int(asalmasalah_anakpr)}")
    elif (anak_pr > 1 and anak_lk > 0):
        if (ayah == "0" and kakek == 0 and cucu_pr == 0 and cucu_lk == 0):
            asalmasalah_anakpr = (6 / 4) * 1
        else:
            asalmasalah_anakpr = (asalmasalah / 4) * 1
        print(
            f"Tampil Siham Masalah Anak Perempuan : {int(asalmasalah_anakpr)}")
    elif (anak_pr == 1 and anak_lk == 0):
        if (ayah == "0" and kakek == 0 and cucu_pr == 0 and cucu_lk == 0):
            asalmasalah_anakpr = (6 / 2) * 1
        else:
            asalmasalah_anakpr = (asalmasalah / 2) * 1
        print(
            f"Tampil Siham Masalah Anak Perempuan : {int(asalmasalah_anakpr)}")
    elif (anak_pr == 0):
...
if (jumlahasalmasalah == asalmasalah):
    ...
    asalmasalah_sisa = asalmasalah - asalmasalah_ayah - ambil_asalmasalah - \
        asalmasalah_anakpr - asalmasalah_ibu
    ...
    print(f"Asal Masalah Sisa : {int(asalmasalah_sisa)}")
    print(f"Sisa Harta : {int(sisa_harta)}")
    if (suami == "y"):
            print(f"Bagian Harta Suami : {int(finalbagiansuami)}")
    else:
